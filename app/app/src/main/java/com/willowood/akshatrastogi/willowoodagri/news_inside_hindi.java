...
public class news_inside_hindi extends AppCompatActivity {
    ProgressDialog loading;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news_inside_hindi);

        final ProgressDialog pd = new ProgressDialog(news_inside_hindi.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Utilities.webAppUrl+"?action=getItems",
                        ...
                        try {
                            ...
                            for (int i = 0; i < jarray.length(); i++) {
                                ...
                                if(kast_id.equals(custid)){
                                    ...
                                    Glide.with(news_inside_hindi.this).load(image_link).into(iv_Big);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(news_inside_hindi.this, "Error: Please Check Your Network Condition", Toast.LENGTH_SHORT).show();
        ...
        RequestQueue queue = Volley.newRequestQueue(news_inside_hindi.this);
