...
public class contactpagehindi extends AppCompatActivity {
    ...
    public static String TWITTER_URL = "https://www.twitter.com/willowood.india";
    public static String TWITTER_PAGE_ID = "Willowood India";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contactpagehindi);
        ...
        twitter.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String facebookUrl = getTwitterPage(contactpagehindi.this);
        ...
        Youtube.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String facebookUrl = getYoutube(contactpagehindi.this);
        ...
        facebook.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String facebookUrl = getFacebookPageURL(contactpagehindi.this);
        ...
        link.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String linkedinURL = getLinkedinPageURL(contactpagehindi.this);
    ...
    private void makePhoneCall(){
        if (ContextCompat.checkSelfPermission(contactpagehindi.this,
                android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(contactpagehindi.this,
