...
public class UserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (abhiabhiaaya) {
            ...
            ArrayAdapter<String> occupationadapter = new ArrayAdapter<String>(UserProfile.this,
            ...
            occupation.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    if (i == 0) {
                        ...
                        occupationtext.setText("Dealer/Distributor");
                    } else if (i == 7) {
            ...
            buttonsave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (State == "") {
                        ...
                        SharedPreferences state = getApplicationContext().getSharedPreferences("state", 0);
                        SharedPreferences.Editor editor1 = state.edit();

                        editor1.putString("user_stat", State);
                        editor1.apply();
                    }
                    ...
                    if (Name.isEmpty() || Name.length() < 3 || Name.length() > 20) {
                        ...
                        Intent registerIntent = new Intent(UserProfile.this, ProfilePage.class);
                        UserProfile.this.startActivity(registerIntent);
                        saveUserInformation();
    ...
    private void saveUserInformation(){
        ...
        SharedPreferences ekbarregister = getSharedPreferences("ekbarregister", 0);
        SharedPreferences.Editor editor2 = ekbarregister.edit();
        editor2.putBoolean("ebr", true);
        editor2.apply();
