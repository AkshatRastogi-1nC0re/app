...
public class NewsHindi extends AppCompatActivity implements CourseAdapter.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_hindi);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Utilities.webAppUrl+"?action=getItems",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            CourseAdapter courseAdapter = new CourseAdapter(NewsHindi.this, courseModelArrayList,NewsHindi.this::onNoteClick);
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(NewsHindi.this, LinearLayoutManager.VERTICAL, false);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(NewsHindi.this, "Error: Please Contact Akshat Rastogi", Toast.LENGTH_SHORT).show();
        ...
        RequestQueue queue = Volley.newRequestQueue(NewsHindi.this);
    ...
    public void onNoteClick(int position) {
        Intent intent = new Intent(this, news_inside_hindi.class);
